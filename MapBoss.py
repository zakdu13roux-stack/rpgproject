"""
Description:
    Variante de la carte pour progression vers un combat de boss.
Entrées:
    Aucune.
Sorties:
    Aucune.
...
class MapBoss(arcade.View):
    def __init__(self,player,cpt=1,cleared_lvls=0):
        """
        Description:
            Initialise la carte de progression vers le boss.
        Entrées:
